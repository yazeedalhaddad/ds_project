...
# --- Configuration ---
# The base URL for the KoDa GTFS-RT TripUpdates API endpoint.
BASE_URL = "https://api.koda.trafiklab.se/KoDa/api/v2/gtfs-rt/sl/TripUpdates"

# Directory where the downloaded zip files will be saved.
OUTPUT_DIR = "gtfs_rt_data"
...
def download_data_for_day(date_str, api_key):
    ...
    output_filename = f"sl-TripUpdates-{date_str}.7z"
